  ...
  const [links] = useState([
    {
      ...
      description: "A reliable and fast Murmur3 hash function implementation built in Rust with production-readiness in mind.",
      targs: ["Rust", "C++"],
    },
    {
      title: "🧮 alex-go",
      ...
      description: "A Go implementation of Microsoft's ALEX learned index structure designed for scalable database indexing.",
    ...
    },
    {
      ...
      description: "A multi-discriminator GAN implementation powered by PyTorch's TCP/IP stack for distributed training.",
    ...
    },
    {
      ...
      description: "A hybrid recommender system combining collaborative and content-based filtering on Spotify datasets.",
  ...
  return (
    <div className='app'>
      ...
      <header>
        ...
        <h2>
          Engineer in Computer Science with a focus on Data Science and Distributed Systems
        </h2>
        <nav>
